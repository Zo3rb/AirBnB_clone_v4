...
def numbersandevenness(n):
    """display a HTML page only if n is an integer H1 tag: “Number: n is even|odd” inside the tag BODY"""
    if n % 2 == 0:
        evood = 'even'
    else:
        evood = 'odd'
    return render_template('6-number_odd_or_even.html', n=n, evood=evood)
